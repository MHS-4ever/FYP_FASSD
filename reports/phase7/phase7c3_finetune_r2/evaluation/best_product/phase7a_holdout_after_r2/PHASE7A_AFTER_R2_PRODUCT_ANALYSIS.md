...
The **legacy binary origin accuracy** is low on this 25-file controlled suite (**12/25 yes**, 11 wrong, 2 borderline). That metric treats human replay and channel-processed human audio as failures when the model outputs FAKE.
...
| direct_ai_file_level_missed_but_segment_suspicious | 2 |
| direct_ai_missed (clean file-level miss) | 3 |
| direct_ai_borderline | 0 |
| processed_human_manipulation_detected | 4 |
| processed_human_missed | 6 |
| ai_replay_or_processed_detected | 2 |
...
| segment_suspicious (any file) | 18 |
...
**Borderline rate** (|decision_score − threshold| ≤ 0.05): 2/25
...
| --- | --- | --- | --- | --- | --- |
| T1.1 | REAL | 0.4 | 0.7 | clean_human_accepted |  |
| T1.2 | REAL | 0.1025641025641025 | 0.7 | clean_human_accepted |  |
| T4.1 | REAL | 0.0888888888888888 | 0.7 | clean_human_accepted |  |
...
| --- | --- | --- | --- | --- | --- | --- |
| T1.4 | REAL | 0.125 | 0.9589625000953674 | 0.125 | True | direct_ai_file_level_missed_but_segment_suspicious |
| T4.2 | REAL | 0.125 | 0.9589625000953674 | 0.125 | True | direct_ai_file_level_missed_but_segment_suspicious |
...
| --- | --- | --- | --- | --- |
| T1.3 | REAL | 0.1428571428571428 | 0.9303950071334839 | 0.14285714285714285 |
| T1.5 | REAL | 0.1428571428571428 | 0.9297599792480469 | 0.14285714285714285 |
| T3.1 | REAL | 0.1428571428571428 | 0.9303950071334839 | 0.14285714285714285 |
...
| T2.2 | mixer_processed | FAKE | 0.7 | processed_human_manipulation_detected | True |
...
| T5.2 | edited_spliced | REAL | 0.4 | processed_human_missed | False |
| T5.3 | edited_spliced | REAL | 0.125 | processed_human_missed | False |
| T5.4 | edited_spliced | REAL | 0.375 | processed_human_missed | False |
...
| --- | --- | --- | --- | --- |
| T3.2 | ai_replay | FAKE | 0.7142857142857143 | ai_replay_or_processed_detected |
...
| --- | --- | --- | --- | --- | --- | --- |
| T3.3 | ai_replay | REAL | 0.5714285714285714 | 0.9964687824249268 | 0.5714285714285714 | ai_replay_file_level_missed_but_segment_suspicious |
| T3.4 | mixer_processed | REAL | 0.375 | 0.9999964237213135 | 0.375 | processed_ai_file_level_missed_but_segment_suspicious |
...
| --- | --- | --- | --- | --- |
| T3.5 | ai_replay | REAL | 0.1428571428571428 | 0.8908652067184448 |
...
| inside_region_avg_spoof | 0.39416445791721344 |
| outside_region_avg_spoof | 0.21234576805727556 |
...
| --- | --- | --- | --- | --- | --- |
| T4.3 | REAL | True | 0.20516009951279557 | 0.11749534642233203 | partial_fabrication_detected |
| T5_FAB_001 | REAL | True | 0.39416445791721344 | 0.21234576805727556 | partial_fabrication_detected |
...
| --- | --- | --- | --- | --- | --- | --- |
| T2.1 | human_replay | FAKE | 1.0 | 9 | 1.0 | 0.9999586343765259 |
| T2.4 | human_replay | FAKE | 0.9 | 9 | 0.9 | 0.9999819993972778 |
| T2.3 | human_replay | FAKE | 0.875 | 7 | 0.875 | 0.9994797110557556 |
| T4.5 | whatsapp_compressed | FAKE | 0.8 | 4 | 0.8 | 0.9999263286590576 |
| T3.2 | ai_replay | FAKE | 0.7142857142857143 | 5 | 0.7142857142857143 | 0.9995380640029907 |
| T2.2 | mixer_processed | FAKE | 0.7 | 7 | 0.7 | 0.9714828729629517 |
| T3.3 | ai_replay | REAL | 0.5714285714285714 | 4 | 0.5714285714285714 | 0.9964687824249268 |
| T1.1 | clean_direct | REAL | 0.4 | 4 | 0.4 | 0.9808576107025146 |
| T5.2 | edited_spliced | REAL | 0.4 | 4 | 0.4 | 0.8988553285598755 |
| T3.4 | mixer_processed | REAL | 0.375 | 3 | 0.375 | 0.9999964237213135 |

### Exploratory candidate suspicious regions (top 3 per file, not GT)

**T1.1:**
- #1: 0.0–4.0s, max_spoof=0.981, chunks=1
- #2: 21.0–25.0s, max_spoof=0.970, chunks=1
- #3: 12.0–19.0s, max_spoof=0.853, chunks=2

**T1.2:**
- #1: 102.0–106.0s, max_spoof=0.979, chunks=1
- #2: 84.0–91.0s, max_spoof=0.977, chunks=2
- #3: 108.0–112.0s, max_spoof=0.930, chunks=1

**T1.3:**
- #1: 15.0–19.0s, max_spoof=0.930, chunks=1

**T1.4:**
- #1: 0.0–4.0s, max_spoof=0.959, chunks=1
...
**T2.2:**
- #1: 12.0–31.0s, max_spoof=0.971, chunks=6
- #2: 0.0–4.0s, max_spoof=0.691, chunks=1

**T2.3:**
- #1: 9.0–28.0s, max_spoof=0.999, chunks=6
- #2: 0.0–4.0s, max_spoof=0.865, chunks=1

**T2.4:**
- #1: 9.0–31.0s, max_spoof=1.000, chunks=7
- #2: 0.0–7.0s, max_spoof=0.991, chunks=2

**T2.5:**
- #1: 0.0–4.0s, max_spoof=0.994, chunks=1
- #2: 18.0–22.0s, max_spoof=0.813, chunks=1

**T3.1:**
- #1: 15.0–19.0s, max_spoof=0.930, chunks=1

**T3.2:**
- #1: 6.0–19.0s, max_spoof=1.000, chunks=4
- #2: 0.0–4.0s, max_spoof=0.729, chunks=1

**T3.3:**
- #1: 0.0–4.0s, max_spoof=0.996, chunks=1
- #2: 15.0–22.0s, max_spoof=0.956, chunks=2
- #3: 6.0–10.0s, max_spoof=0.836, chunks=1

**T3.4:**
- #1: 0.0–4.0s, max_spoof=1.000, chunks=1
- #2: 15.0–22.0s, max_spoof=0.959, chunks=2

**T3.5:**
- #1: 0.0–4.0s, max_spoof=0.891, chunks=1

**T4.1:**
- #1: 177.0–181.0s, max_spoof=0.954, chunks=1
- #2: 69.0–73.0s, max_spoof=0.949, chunks=1
- #3: 3.0–10.0s, max_spoof=0.921, chunks=2

**T4.2:**
- #1: 0.0–4.0s, max_spoof=0.959, chunks=1

**T4.3:**
- #1: 15.0–19.0s, max_spoof=1.000, chunks=1
- #2: 114.0–118.0s, max_spoof=0.707, chunks=1
- #3: 48.0–55.0s, max_spoof=0.704, chunks=2

**T4.5:**
- #1: 0.0–13.0s, max_spoof=1.000, chunks=4

**T5.1:**
- #1: 0.0–4.0s, max_spoof=0.909, chunks=1
- #2: 9.0–13.0s, max_spoof=0.740, chunks=1

**T5.2:**
- #1: 0.0–4.0s, max_spoof=0.899, chunks=1
- #2: 18.0–22.0s, max_spoof=0.855, chunks=1
- #3: 24.0–28.0s, max_spoof=0.811, chunks=1

**T5.3:**
- #1: 9.0–13.0s, max_spoof=0.782, chunks=1

**T5.4:**
- #1: 9.0–19.0s, max_spoof=0.955, chunks=3

**T5.5:**
- #1: 0.0–7.0s, max_spoof=0.970, chunks=2
- #2: 9.0–13.0s, max_spoof=0.762, chunks=1

**T5_FAB_001:**
- #1: 12.0–16.0s, max_spoof=0.693, chunks=1
