...
**Round-1 (23 bases, 184 files):**

| Split | `base_id` range |
|-------|-----------------|
| train | `base_001` – `base_016` (16 bases × 8 = 128 files) |
| val | `base_017` – `base_019` (3 × 8 = 24 files) |
| test | `base_020` – `base_023` (4 × 8 = 32 files) |

Assigned automatically by `build_phase7c1_manifest_from_audio.py`.
