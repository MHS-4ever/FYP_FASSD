...
Case ID: phase9d_human_replay_002_human_003_replay_laptop_mobile
...
Replay: experimental evidence indicator 'elevated_replay_rerecording_indicator' (strength=high, probability=0.986). This is not a final forensic proof.
Mixer/channel: experimental evidence indicator 'low_indicator' (strength=low, probability=0.284). This is not a final forensic proof.
...
## Candidate segments
Top candidate segments: candidate segment seg_0003 (6.0s-10.0s) partial indicator=0.9999999999999998; candidate segment seg_0011 (22.0s-26.0s) partial indicator=0.9999999999999947; candidate segment seg_0013 (26.0s-30.0s) partial indicator=0.9999999999923852. Manual review recommended.
