...
List the later objectives: multi-axis evidence, origin/replay/mixer/channel/partial-fabrication indicators, evidence-based reporting, local testing interface, and intended web-based frontend.
...
Explain the system interface clearly: Gradio/FastAPI was used for local demo/testing, while the intended final user-facing interface is the Next.js web application integrated with the backend.
...
Suggest broader external testing, improved replay/mixer generalization, better compressed-audio handling, stronger partial localization, finalized Next.js integration, improved dataset diversity, and expert forensic validation.
